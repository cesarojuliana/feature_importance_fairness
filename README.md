...
SHAP is a technique that produces local explanations for classifier predictions. The technique can be applied to any machine learning model. For reference the paper that descibes SHAP can be found [here](http://papers.nips.cc/paper/7062-a-unified-approach-to-interpreting-model-predictions)
